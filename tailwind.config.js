  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'web3-gradient': 'linear-gradient(135deg, #1e3a8a 0%, #0c1842 100%)',
        'web3-mesh': 'linear-gradient(135deg, rgba(77, 124, 232, 0.1) 0%, rgba(99, 102, 241, 0.1) 100%)',
        'midnight-gradient': 'linear-gradient(135deg, #0a0e1a 0%, #162554 50%, #1e3a8a 100%)',
        'blue-radial': 'radial-gradient(circle at 50% 50%, #1e3a8a 0%, #0a0e1a 100%)',
      },
      boxShadow: {

                ...
                <div className="flex flex-col sm:flex-row justify-between items-center sm:items-start gap-10">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        ...
                        <div className="flex mt-2 space-x-4 justify-center">
                            <a href="https://www.linkedin.com/in/kaci-hamroun/" aria-label="Visitez mon profil LinkedIn" className="text-2xl text-gray-400 hover:text-accent transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-accent rounded-lg p-1" target="_blank" rel="noreferrer">
                                <FaLinkedinIn />
                            </a>
                            <a href="https://github.com/kaciham" aria-label="Visitez mon profil GitHub" className="text-2xl text-gray-400 hover:text-accent transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-accent rounded-lg p-1" target="_blank" rel="noreferrer">
                                <FaGithub />
                            </a>
                        </div>
                    </div>
